...
void SelectBlock(void)
{
	...
	//連鎖が３つ以上か調べる	
		...
		{
			//連鎖が３つ以上ならブロックを消しブロック移動処理へ移動する
			Stage_State = 1;
		}
		//次にクリックs＋できるようにClockFlfagを０にする
		ClickStatus = E_NONE;
	}    
}
/************************
...
void CheckBlock(void)
{
	...
	{
		//連鎖が３つ以上ンらブロックを消してブロック移動処理へ移行する
		Stage_State = 1;
	}
}
/************************
...
*備考：クリア条件フラグを０とし、各スクールの消去ブロックがレベルよりも数が少なかったらチェック処理を中断してゲームを続行する・
*
